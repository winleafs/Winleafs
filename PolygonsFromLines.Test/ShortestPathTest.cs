...
namespace PolygonsFromLines.Test
{
    ...
    public class ShortestPathTest
    {
        ...
        public void Test_ShortestPath1()
        {
            ...
            //A malformed hexagon
            var vertex1 = new GraphVertex(new PointF(1, 0));
            var vertex2 = new GraphVertex(new PointF(2, 0));
            var vertex3 = new GraphVertex(new PointF(-0.5f, 1.5f));
            var vertex4 = new GraphVertex(new PointF(3, 1.5f));
            var vertex5 = new GraphVertex(new PointF(0.5f, 3));
            var vertex6 = new GraphVertex(new PointF(2.5f, 4));
            var vertex7 = new GraphVertex(new PointF(2, 1.5f));
            ...
            graph.Vertices = new List<GraphVertex>() { vertex1, vertex2, vertex3, vertex4, vertex5, vertex6, vertex7 };
