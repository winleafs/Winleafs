	...
	public class ScreenMirrorEffect : ICustomEffect
	{
		...
		public ScreenMirrorEffect(Orchestrator orchestrator, INanoleafClient nanoleafClient)
		{
			...
			try
			{
				...
				{
					_screenMirrorEffect = new ScreenMirror(orchestrator.PanelLayout, nanoleafClient, ScaleType.Fit, flipType);
				}
				else if (_screenMirrorAlgorithm == ScreenMirrorAlgorithm.ScreenMirrorStretch)
				{
					_screenMirrorEffect = new ScreenMirror(orchestrator.PanelLayout, nanoleafClient, ScaleType.Stretch, flipType);
				}
